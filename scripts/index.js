...
const popupAddElement = document.querySelector('.popup__element');
...
function openedPopupAddElement() {
  popupAddElement.classList.add('popup__element_open');
}

function closePopupAddElement() {
  popupAddElement.classList.remove('popup__element_open');
}
