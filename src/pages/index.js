...
import {initialCards, config, popupProfile, buttonOpenPopupProfile, elementList, templateElement, popupAddElement, elementAddButton,
  elementTitleInput, elementImgInput, buttonElement, popupButton, inputList,
  formPopupProfile, formPopupAddElement, bigImagePopup} from '../utils/constants.js';
...
const cardList = new Section({
  ...
  renderer: (item) => {
    ...
    const popupImageOpen = new PopupWithImage(name, link, bigImagePopup);
    const card = new Card(name, link, templateElement, popupImageOpen);
    const element = card.render(elementList);
